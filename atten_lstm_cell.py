...
class LSTMCell(LayerRNNCell):
  ...
  def attention_model(self, previous_states, data):
    ...
    # '(?, 1, 6)'
    middle4 = tf.multiply(self._weights_wt, tf.tanh(middle1))
  ...
  def call(self, inputs, state):
    ...
    # So, at here, we use state & input to calculate the attention weights
    if True:
        # print("Attention used")
        inputs = self.attention_model(previous_states=m_prev, data=inputs)
